...
<#
.SYNOPSIS
    This scripts configures a Windows Server Core based container with Terrafom, the selected PowerShell modules and 
...
.DESCRIPTION
    ...
    with the latest version of the Azure DevOps agent, Terrafom and the selected PowerShell modules (by default AzureRM, AzureAD, Pester). 
